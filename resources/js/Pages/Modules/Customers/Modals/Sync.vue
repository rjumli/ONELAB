<template>
    <b-modal v-model="showModal" hide-footer header-class="p-3 bg-light" style="--vz-modal-width: 600px;" class="v-modal-custom" modal-class="zoomIn" centered>
        <template v-slot:header>
            <h5 class="modal-title">Sync Customers</h5>
                        ...
                        <div class="text-center">
                            ...
                            <div class="p-2 mt-4">
                                <form @submit.prevent="preview" enctype="multipart/form-data">
                                    <p class="text-muted">Sync <span class="fs-bold text-success">{{syncable}}</span> customers to the central server.</p>
                                    <p class="text-muted mt-n3">It will syncronize customers data to the central server.</p>
...
export default {
    ...
    methods : {
        ...
        sync(){
            ...
            axios.post(this.currentUrl + '/sync/customers-upload')
            .then(response => {
