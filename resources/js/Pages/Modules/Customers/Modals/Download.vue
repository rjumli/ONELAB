<template>
    <b-modal v-model="showModal" hide-footer header-class="p-3 bg-light" style="--vz-modal-width: 600px;" class="v-modal-custom" modal-class="zoomIn" centered>
        <template v-slot:header>
            <h5 class="modal-title">Download Customers</h5>
                        ...
                        <div class="text-center">
                            ...
                            <div class="p-2 mt-4">
                                <form @submit.prevent="preview" enctype="multipart/form-data">
                                    <p v-if="!result" class="text-muted">Download all customers from the central server. This is to avoid typographical error when populating the system.</p>
                                    <p v-else class="text-muted">Customers was downloaded from central server.</p>
...
export default {
    ...
    methods : {
        ...
        sync(){
            ...
            axios.post(this.currentUrl + '/sync/customers-download')
            .then(response => {
