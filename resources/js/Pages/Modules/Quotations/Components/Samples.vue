                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h4 class="mb-0 fs-14"><span class="counter-value">{{(code) ? code : 'Not yet available'}}</span></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h4 class="mb-0 fs-14"><span class="counter-value">{{samples.length}}</span></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-none border">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <p class="text-uppercase fw-semibold fs-12 text-muted mb-1">Laboratory</p>
                            <h4 class="mb-0 fs-14"><span class="counter-value">{{lab}}</span></h4>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    components: { Create, View, Analysis, simplebar },
    props: ['id','laboratory','received','due','status','code','lab'],
    data(){
        return {
