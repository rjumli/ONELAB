<template lang="">
    <PageHeader title="List of Municipalities" pageTitle="Location" />
                ...
                <table class="table table-nowrap align-middle mb-0">
                    <thead class="table-light">
                        <tr class="fs-11">
                            ...
                            <th style="width: 10%;" class="text-center">Zipcode</th>
                    ...
                    <tbody>
                        <tr v-for="(list,index) in lists" v-bind:key="index">
                            ...
                            <td class="text-center">{{(list.zipcode) ? list.zipcode : 'n/a'}}</td>
    ...
    <Municipality :regions="regions" ref="municipality"/>
</template>
<script>
import Municipality from './Modals/Municipality.vue';
import Pagination from "@/Shared/Components/Pagination.vue";
import PageHeader from '@/Shared/Components/PageHeader.vue';
export default {
    components: { PageHeader, Pagination, Municipality },
    props: ['regions'],
    data(){
        return {
            lists: [],
