<template lang="">
    <PageHeader title="List of Provinces" pageTitle="Location" />
                ...
                <table class="table table-nowrap align-middle mb-0">
                    ...
                    <tbody>
                        <tr v-for="(list,index) in lists" v-bind:key="index">
                            ...
                            <td class="text-center">{{list.region.region}} <span class="text-muted fs-12">({{list.region.name}})</span></td>
                            <td class="text-end">
    ...
    <Province :regions="regions" ref="province"/>
</template>
<script>
import Province from './Modals/Province.vue';
import Pagination from "@/Shared/Components/Pagination.vue";
import PageHeader from '@/Shared/Components/PageHeader.vue';
export default {
    props: ['regions'],
    components: { PageHeader, Pagination, Province },
    data(){
        return {
            lists: [],
            meta: {},
