<template lang="">
    <PageHeader title="List of Regions" pageTitle="Location" />
                ...
                <table class="table table-nowrap align-middle mb-0">
                    <thead class="table-light">
                        <tr class="fs-11">
                            ...
                            <th style="width: 15%;" class="text-center">Island</th>
...
<script>
import Region from './Modals/Region.vue';
import Pagination from "@/Shared/Components/Pagination.vue";
import PageHeader from '@/Shared/Components/PageHeader.vue';
export default {
    components: { PageHeader, Pagination, Region },
    data(){
        return {
            lists: [],
            meta: {},
